...
JNIEXPORT void JNICALL native_SetParamsFloat(JNIEnv *env, jobject instance, jint type, jfloat x, jfloat y) {

}

JNIEXPORT void JNICALL native_SetImageData(JNIEnv *env, jobject instance, jint format, jint width, jint height, jbyteArray bytes) {

}

JNIEXPORT void JNICALL native_SetImageDataWithIndex(JNIEnv *env, jobject instance, jint index, jint format, jint width, jint height, jbyteArray bytes) {
